...
export const getImageUrl = (imagePath, type = 'profile') => {
  // Default placeholders with white accent
  const defaultProfilePicture = 'https://ui-avatars.com/api/?name=User&background=FFFFFF&color=000&size=150';
  const defaultCoverPhoto = 'https://via.placeholder.com/600x200/FFFFFF/000000?text=Cover+Photo';
